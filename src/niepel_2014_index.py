...
data = {
    ...
    'fig_args': {
        'cell_line_nodeedge': FigArgs('cell_line', 'nodeedge',
                                      ['MCF7', 'BT-20', 'MDA-MB-453'],
                                      (250, 235)),
        'subtype_nodeedge': FigArgs('cell_line', 'nodeedge',
                                    ['TNBC', 'HER2amp', 'HR+'], (250, 235),
                                    link=False, fname_prefix='NetMap_'),
        'cell_line_subtype': FigArgs('cell_line', 'subtype', ['MCF7'],
                                     (700, 237)),
        'cell_line_topmeasures': FigArgs('cell_line', 'topmeasures', ['MCF7'],
                                         (700, 385)),
        'cell_line_foldchange': FigArgs('cell_line', 'foldchange', ['MCF7'],
                                        (700, 237)),
