# Utility function
# Adds a row or a col of values to an Excel file
...
group = parser.add_mutually_exclusive_group()
group.add_argument('-s', action='store', dest='sheet_index',
                    type=int,
                    help='sheet index to update')
group.add_argument('-sn', '--sheet_name', action='store', 
...
if __name__ == "__main__":
    ...
    if args.new_col:
        new_col(args.inputFile, args.outputFile,
                args.val1,args.val2,
                sheet_index=args.sheet_index,sheet_name=args.sheet_name,
