...
urlpatterns = patterns('',
    ...
    url(r'^db/dataset/$','db.views.datasetIndex', name="listDatasets"),
    url(r'^db/dataset/(?P<facility_id>\d+)/$', 'db.views.datasetDetailMain', name="dataset_detail"),
    url(r'^db/dataset/(?P<facility_id>\d+)/main$', 'db.views.datasetDetailMain', name="dataset_detail_main"),
    url(r'^db/dataset/(?P<facility_id>\d+)/cells$', 'db.views.datasetDetailCells', name="dataset_detail_cells"),
    url(r'^db/dataset/(?P<facility_id>\d+)/proteins$', 'db.views.datasetDetailProteins', name="dataset_detail_proteins"),
    url(r'^db/dataset/(?P<facility_id>\d+)/results$', 'db.views.datasetDetailResults', name="dataset_detail_results"),
