...
#SBATCH -o /n/www/lincs.hms.harvard.edu/support/logs/sbatch_deploy_%j.out   # Standard out goes to this file
#SBATCH -e /n/www/lincs.hms.harvard.edu/support/logs/sbatch_deploy_%j.err   # Standard err goes to this file
